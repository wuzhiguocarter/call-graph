    ...
    function (
        ...
        function extractAllElementsData(element) {
            ...
            children.each(function () {
                var childData = extractAllElementsData(
            ...
            if (currentAttributes) {
                for (var i = 0; i < currentAttributes.length; i++) {
                    ...
                    if (
                        ...
                        var namespaceURIParts =
                            currentAttribute.namespaceURI.split('/')
                        var namespace =
                            namespaceURIParts[namespaceURIParts.length - 1]
                        name = namespace + ':' + name
                    }
        ...
        function pathTweenPoints(node, d1, precision, precisionIsRelative) {
            ...
            var distances = [0]
            var i = 0
            var dt = precisionIsRelative
                ? precision
                : precision / Math.max(n0, n1)
            while ((i += dt) < 1) {
                distances.push(i)
            }
            distances.push(1)
        ...
        function _render(callback) {
            ...
            var convertEqualSidedPolygons =
                this._options.convertEqualSidedPolygons
                ...
                if (
                    ...
                    var childElementsEnter = childrenEnter
                        ...
                        .each(function (d) {
                            ...
                            for (
                                var _i = 0,
                                    _Object$keys = Object.keys(d.attributes);
                                _i < _Object$keys.length;
                                _i++
                            ) {
                                var attributeName = _Object$keys[_i]
            ...
            function attributeElement(data) {
                ...
                if (data.tag == 'svg') {
                    ...
                    if (options.width != null || options.height != null) {
                        ...
                        if (width == null) {
                            width =
                                (data.attributes.width.replace('pt', '') * 4) /
                                3
                        } else {
                        ...
                        if (height == null) {
                            height =
                                (data.attributes.height.replace('pt', '') * 4) /
                                3
                        } else {
                ...
                if (transitionInstance) {
                    elementTransition =
                        elementTransition.transition(transitionInstance)
                    if (fade) {
                        elementTransition
                            .filter(function (d) {
                                return d.tag[0] == '#' ? null : this
                    ...
                    elementTransition
                        ...
                        .on('end', function (d) {
                            d3__namespace
                                ...
                                .attr(
                                    'style',
                                    (d && d.attributes && d.attributes.style) ||
                                        null,
                                )
                        })
                }
                var growThisPath =
                    growEnteringEdges && tag == 'path' && data.offset
                if (growThisPath) {
                ...
                if (moveThisPolygon) {
                    ...
                    var p2 = edgePath
                        .node()
                        .getPointAtLength(data.totalLength - 1)
                    var angle1 =
                    ...
                    elementTransition
                        .attrTween('transform', function () {
                            return function (t) {
                                var p = edgePath
                                    .node()
                                    .getPointAtLength(data.totalLength * t)
                                var p2 = edgePath
                                    .node()
                                    .getPointAtLength(data.totalLength * t + 1)
                                var angle =
                                    (Math.atan2(p2.y - p.y, p2.x - p.x) * 180) /
                                        Math.PI -
                                    angle1
            ...
            if (transitionInstance != null) {
                ...
                if (graphvizInstance._active) {
                    ...
                    root.transition(transitionInstance)
                        .transition()
                        .duration(0)
                        .on('end', function () {
        ...
        var io = ArrayBuffer,
            ...
            pr = function (p, c, d) {
                ...
                var s = new H(d - c)
                return s.set(p.subarray(c, d)), s
            },
            Ye = function (p, c, d, s) {
                if (H.prototype.fill) return H.prototype.fill.call(p, c, d, s)
                for (
                    (d == null || d < 0) && (d = 0),
            ...
            uo = function (p, c, d, s) {
                if (H.prototype.copyWithin)
                    return H.prototype.copyWithin.call(p, c, d, s)
                for (
                    (d == null || d < 0) && (d = 0),
                        (s == null || s > p.length) && (s = p.length);
                    d < s;
            ...
            jr = function (p, c, d) {
                for (var s = 0, f = 0; s < d; ++s) f |= p[c++] << (s << 3)
                return f
            },
            lo = function (p, c) {
                return (
            ...
            co = function (p, c) {
                var d = p[0] | (p[1] << 8) | (p[2] << 16)
                if (d == 3126568 && p[3] == 253) {
                    var s = p[4],
                        f = (s >> 5) & 1,
                        m = (s >> 2) & 1,
                        _ = s & 3,
                    ...
                    return (
                        ...
                        (X[8] = 8),
                        {
                            ...
                            l: 0,
                            d: Q,
                            w: c && c != 1 ? c : X.subarray(12),
                            e: z,
                            o: new qe(X.buffer, 0, 3),
                            u: Y,
                            c: m,
                            m: Math.min(131072, z),
                        }
                    )
                } else if (((d >> 4) | (p[3] << 20)) == 25481893)
                    return lo(p, 4) + 8
                T(0)
            },
            Xe = function (p) {
            ...
            je = function (p, c, d) {
                ...
                ;(h > 255 || _) && T(0)
                for (
                    var b = 0, k = (m >> 1) + (m >> 3) + 3, se = m - 1, oe = 0;
                    oe <= h;
                    ++oe
                ) {
                    var K = Y[oe]
            ...
            fo = function (p, c) {
                var d = 0,
                    ...
                    m = p[c],
                    _ = f.subarray(0, 256),
                    h = f.subarray(256, 268),
                    M = new Qe(f.buffer, 268)
                if (m < 128) {
                    var I = je(p, c + 1, 6),
                        Q = I[0],
                        Z = I[1]
                ...
                for (M[j] = 0, d = j; d > 0; --d) {
                    var oe = M[d]
                    Ye(se, d, oe, (M[d - 1] = oe + h[d] * (1 << (j - d))))
                }
                for (M[0] != W && T(0), d = 0; d < s; ++d) {
                    var K = _[d]
                    if (K) {
                        var L = M[K]
                        Ye(k, d, L, (M[K] = L + (1 << (j - K))))
                    }
                }
                return [c, { n: se, b: j, s: k }]
            },
            vo = je(
                new H([
                    81, 16, 99, 140, 49, 198, 24, 99, 12, 33, 196, 24, 99, 102,
                    102, 134, 70, 146, 4,
                ]),
                0,
                6,
            ...
            mo = je(
                new H([
                    33, 20, 196, 24, 99, 140, 33, 132, 16, 66, 8, 33, 132, 16,
            ...
            _o = je(
                new H([32, 132, 16, 66, 102, 70, 68, 68, 68, 68, 36, 73, 2]),
                0,
                5,
            )[1],
            Pr = function (p, c) {
                for (var d = p.length, s = new qe(d), f = 0; f < d; ++f)
                    (s[f] = c), (c += 1 << p[f])
                return s
            },
            cr = new H(
                new qe([
                    0, 0, 0, 0, 16843009, 50528770, 134678020, 202050057,
                    269422093,
                ]).buffer,
                0,
                36,
            ...
            Ze = function (p, c, d) {
                ...
                m || T(0)
                for (
                    var M = 0, I = d.b, Q = (s << 3) - 8 + Xe(m) - I, Z = -1;
                    Q > h && Z < f;

                ) {
                    var Y = Q >> 3,
                        z =
                            (p[Y] | (p[Y + 1] << 8) | (p[Y + 2] << 16)) >>
                            (Q & 7)
                    ;(M = ((M << I) | z) & _),
                        (c[++Z] = d.s[M]),
                        (Q -= I = d.n[M])
            ...
            wo = function (p, c, d) {
                var s = 6,
                    ...
                    h = m + _
                Ze(
                    p.subarray(s, (s += p[0] | (p[1] << 8))),
                    c.subarray(0, m),
                    d,
                ),
                    Ze(
                        p.subarray(s, (s += p[2] | (p[3] << 8))),
                        c.subarray(m, _),
                        d,
                    ),
                    Ze(
                        p.subarray(s, (s += p[4] | (p[5] << 8))),
                        c.subarray(_, h),
                        d,
                    ),
                    Ze(p.subarray(s), c.subarray(h), d)
            },
            yo = function (p, c, d) {
                var s,
                    f = c.b,
                ...
                if (!(M > p.length)) {
                    if (_ == 0)
                        return (
                            (c.b = M),
                            d
                                ? (d.set(p.subarray(f, M), c.y), (c.y += h), d)
                                : pr(p, f, M)
                        )
                    if (_ == 2) {
                        var I = p[f],
                                  ...
                                  : Z == 2
                                    ...
                                    : ((Y |=
                                      ...
                                      (z =
                                          ...
                                          (p[++f] << 10)))),
                            ++f
                        var X = d ? d.subarray(c.y, c.y + c.m) : new H(c.m),
                            V = X.length - Y
                        if (Q == 0) X.set(p.subarray(f, (f += Y)), V)
                        else if (Q == 1) Ye(X, p[f++], V)
                        else {
                            var re = c.h
                            if (Q == 2) {
                                var S = fo(p, f)
                                ;(z += f - (f = S[0])), (c.h = re = S[1])
                            } else re || T(0)
                            ;(q ? wo : Ze)(
                                p.subarray(f, (f += z)),
                                X.subarray(V),
                        ...
                        if (P) {
                            ...
                            for (++P; --P; ) {
                                ...
                                for (var w = 0; w < _e; ++w) X[A + w] = X[V + w]
                                ;(A += _e), (V += _e)
                                var Ee = A - ce
                                if (Ee < 0) {
                                    var De = -Ee,
                            ...
                            if (A != V) for (; V < X.length; ) X[A++] = X[V++]
                            else A = X.length
                            d ? (c.y += A) : (X = pr(X, 0, A))
                        } else if (d) {
                            if (((c.y += Y), V))
                                for (var w = 0; w < Y; ++w) X[w] = X[V + w]
                        } else V && (X = pr(X, V))
                        return (c.b = M), X
                    }
                    T(2)
            ...
            bo = function (p, c) {
                ...
                for (var d = new H(c), s = 0, f = 0; s < p.length; ++s) {
                    var m = p[s]
        ...
        function Eo(p, c) {
            for (var d = [], s = +!c, f = 0, m = 0; p.length; ) {
                var _ = co(p, s || c)
                if (typeof _ == 'object') {
                    for (
                        s
        ...
        var Mo = (() => {
                typeof document < 'u' ? document.currentScript?.src : void 0
                return function (c = {}) {
                    var d,
                        s = c,
                        f,
                    ...
                    Object.assign(s, M), (M = null)
                    var re
                    s.wasmBinary && (re = s.wasmBinary)
                    var S,
                        P = !1
                    function J(e, r) {
                        e || _e(r)
                    ...
                    function K() {
                        ...
                        ;(s.HEAP8 = w = new Int8Array(e)),
                            (s.HEAP16 = W = new Int16Array(e)),
                            (s.HEAPU8 = j = new Uint8Array(e)),
                            (s.HEAPU16 = new Uint16Array(e)),
                            (s.HEAP32 = b = new Int32Array(e)),
                            (s.HEAPU32 = k = new Uint32Array(e)),
                            (s.HEAPF32 = new Float32Array(e)),
                            (s.HEAPF64 = oe = new Float64Array(e))
                    }
                    var L = [],
                        A = [],
                        Le = []
                    ...
                    function Ne() {
                        !s.noFSInit && !o.init.initialized && o.init(),
                    ...
                    var Ge = 'data:application/octet-stream;base64,',
                        Ee = e => e.startsWith(Ge),
                        De = e => e.startsWith('file://')
                    function We() {
                        var e = 'graphvizlib.wasm'
                        return Ee(e) ? e : Y(e)
                    }
                    var Je
                    function fr(e) {
                        if (e == Je && re) return new Uint8Array(re)
                        throw 'both async and sync fetching of the wasm failed'
                    }
                    function Jr(e) {
                        return re
                            ? Promise.resolve().then(() => fr(e))
                            : z(e).then(
                                  r => new Uint8Array(r),
                                  () => fr(e),
                              )
                    ...
                    function vr(e, r, t) {
                        return Jr(e)
                            ...
                            .then(t, n => {
                                V(
                                    `failed to asynchronously prepare wasm: ${n}`,
                                ),
                                    _e(n)
                            })
                    }
                    function Sr(e, r, t, n) {
                        return !e &&
                            ...
                            ? fetch(r, { credentials: 'same-origin' }).then(
                                  a => {
                                      var i = WebAssembly.instantiateStreaming(
                                          a,
                                          t,
                                      )
                                      return i.then(n, function (u) {
                                          return (
                                              V(
                                                  `wasm streaming compile failed: ${u}`,
                                              ),
                                              V(
                    ...
                    function Tr() {
                        ...
                        return Je || (Je = We()), Sr(re, Je, e, t).catch(m), {}
                    }
                    var R,
                        $,
                        Qr = {
                            172808: (e, r) => {
                                var t = ue(e),
                                    n = ue(r)
                                o.createPath('/', C.dirname(t)),
                                    o.writeFile(C.join('/', t), n)
                            },
                        }
                    function qr(e) {
                    ...
                    var mr = 0,
                        ...
                        he = {
                            ...
                            relative: (e, r) => {
                                ;(e = he.resolve(e).substr(1)),
                                    (r = he.resolve(r).substr(1))
                                function t(E) {
                                    for (
                                        var G = 0;
                                        G < E.length && E[G] === '';
                                ...
                                for (var v = [], l = u; l < n.length; l++)
                                    v.push('..')
                                return (v = v.concat(a.slice(u))), v.join('/')
                            },
                        },
                        gr =
                        ...
                        Fe = (e, r, t) => {
                            ...
                            if (a - r > 16 && e.buffer && gr)
                                return gr.decode(e.subarray(r, a))
                            for (var i = ''; r < a; ) {
                                var u = e[r++]
                                if (!(u & 128)) {
                    ...
                    var rt = () => {
                        ...
                        tt = (e, r) => (j.fill(0, e, e + r), e),
                        hr = (e, r) => Math.ceil(e / r) * r,
                        wr = e => {
                            e = hr(e, 65536)
                            var r = Zr(65536, e)
                            return r ? tt(r, e) : 0
                        ...
                        D = {
                            ...
                            createNode(e, r, t, n) {
                                ...
                                return (
                                    o.isDir(a.mode)
                                        ? ((a.node_ops = D.ops_table.dir.node),
                                          (a.stream_ops =
                                              D.ops_table.dir.stream),
                                          (a.contents = {}))
                                        : o.isFile(a.mode)
                                          ? ((a.node_ops =
                                                D.ops_table.file.node),
                                            (a.stream_ops =
                                                D.ops_table.file.stream),
                                            (a.usedBytes = 0),
                                            (a.contents = null))
                                          : o.isLink(a.mode)
                                            ? ((a.node_ops =
                                                  D.ops_table.link.node),
                                              (a.stream_ops =
                                                  D.ops_table.link.stream))
                                            : o.isChrdev(a.mode) &&
                                              ((a.node_ops =
                                                  D.ops_table.chrdev.node),
                                              (a.stream_ops =
                                                  D.ops_table.chrdev.stream)),
                            ...
                            stream_ops: {
                                read(e, r, t, n, a) {
                                    ...
                                    var u = Math.min(e.node.usedBytes - a, n)
                                    if (u > 8 && i.subarray)
                                        r.set(i.subarray(a, a + u), t)
                                    else
                                        for (var l = 0; l < u; l++)
                                            r[t + l] = i[a + l]
                                    return u
                                ...
                                write(e, r, t, n, a, i) {
                                    ...
                                    if (
                                        (D.expandFileStorage(u, a + n),
                                        u.contents.subarray && r.subarray)
                                    )
                                        u.contents.set(r.subarray(t, t + n), a)
                                    else
                                        for (var l = 0; l < n; l++)
                                            u.contents[a + l] = r[t + l]
                                    return (
                                        (u.usedBytes = Math.max(
                                            u.usedBytes,
                                            a + n,
                                        )),
                                        n
                                ...
                                allocate(e, r, t) {
                                    D.expandFileStorage(e.node, r + t),
                                ...
                                msync(e, r, t, n, a) {
                                    return (
                                        D.stream_ops.write(e, r, 0, n, t, !1), 0
                                    )
                                },
                            },
                        },
                        ...
                        it = (e, r, t, n) => {
                            ...
                            return (
                                at.forEach(i => {
                                    a ||
                                        (i.canHandle(r) &&
                                            (i.handle(e, r, t, n), (a = !0)))
                                }),
                                a
                            )
                        },
                        st = (e, r, t, n, a, i, u, l, v, E) => {
                            var G = r ? he.resolve(C.join2(e, r)) : e
                            function B(y) {
                                function O(te) {
                                    E?.(),
                                        l || nt(e, r, te, n, a, v),
                            ...
                            ce(), typeof t == 'string' ? ot(t, B, u) : B(t)
                        },
                        ut = e => {
                            var r = {
                                    r: 0,
                        ...
                        o = {
                            ...
                            lookupPath(e, r = {}) {
                                ...
                                for (
                                    ...
                                    if (
                                        ...
                                        for (var v = 0; o.isLink(a.mode); ) {
                                            var E = o.readlink(i)
                                            i = he.resolve(C.dirname(i), E)
                                            var G = o.lookupPath(i, {
                                                recurse_count:
                                                    r.recurse_count + 1,
                                            })
                                            if (((a = G.node), v++ > 40))
                            ...
                            unmount(e) {
                                ...
                                Object.keys(o.nameTable).forEach(u => {
                                    for (var l = o.nameTable[u]; l; ) {
                                        var v = l.name_next
                                        a.includes(l.mount) && o.destroyNode(l),
                                            (l = v)
                                    }
                                }),
                                    (t.mounted = null)
                            ...
                            symlink(e, r) {
                                if (!he.resolve(e)) throw new o.ErrnoError(44)
                            ...
                            rename(e, r) {
                                var t = C.dirname(e),
                                    ...
                                    v
                                if (
                                    ((u = o.lookupPath(e, { parent: !0 })),
                                    (l = u.node),
                                    (u = o.lookupPath(r, { parent: !0 })),
                                    (v = u.node),
                                    !l || !v)
                                )
                                ...
                                if (E !== x) {
                                    ...
                                    if (
                                        v !== l &&
                                        ((y = o.nodePermissions(l, 'w')), y)
                                    )
                                        throw new o.ErrnoError(y)
                                    o.hashRemoveNode(E)
                                    try {
                                        l.node_ops.rename(E, v, i),
                                            (E.parent = v)
                                    } catch (O) {
                                        throw O
                                    } finally {
                            ...
                            open(e, r, t) {
                                ...
                                if (!n) throw new o.ErrnoError(44)
                                if (
                                    (o.isChrdev(n.mode) && (r &= -513),
                                    r & 65536 && !o.isDir(n.mode))
                                )
                                    throw new o.ErrnoError(54)
                                if (!i) {
                                    var u = o.mayOpen(n, r)
                            ...
                            read(e, r, t, n, a) {
                                ...
                                var u = e.stream_ops.read(e, r, t, n, a)
                            ...
                            write(e, r, t, n, a, i) {
                                ...
                                var l = e.stream_ops.write(e, r, t, n, a, i)
                            ...
                            createStandardStreams() {
                                s.stdin
                                    ? o.createDevice('/dev', 'stdin', s.stdin)
                            ...
                            createLazyFile(e, r, t, n, a) {
                                class i {
                                    ...
                                    get(y) {
                                        if (!(y > this.length - 1 || y < 0)) {
                                            var O = y % this.chunkSize,
                                                te = (y / this.chunkSize) | 0
                                            return this.getter(te)[O]
                                        }
                                    }
                                    setDataGetter(y) {
                                        this.getter = y
                                ...
                                var v = o.createFile(e, r, l, n, a)
                                l.contents
                                    ? (v.contents = l.contents)
                                    : l.url &&
                                      ((v.contents = null), (v.url = l.url)),
                                ...
                                var E = {},
                                    G = Object.keys(v.stream_ops)
                                G.forEach(B => {
                                    var y = v.stream_ops[B]
                                    E[B] = (...O) => (
                                        o.forceLoadFile(v), y(...O)
                                    )
                                })
                                function x(B, y, O, te, de) {
                                    var ne = B.node.contents
                                    if (de >= ne.length) return 0
                                    var fe = Math.min(ne.length - de, te)
                                    if (ne.slice)
                                ...
                                return (
                                    (E.read = (B, y, O, te, de) => (
                                        o.forceLoadFile(v), x(B, y, O, te, de)
                                    )),
                                    (E.mmap = (B, y, O, te, de) => {
                                        o.forceLoadFile(v)
                                        var ne = wr(y)
                    ...
                    function Se() {
                        var e = b[+U.varargs >> 2]
                        return (U.varargs += 4), e
                    }
                    var Oe = Se
                    function lt(e, r, t) {
                        U.varargs = t
                        try {
                            var n = U.getStreamFromFD(e)
                            switch (r) {
                                case 0: {
                                    var a = Se()
                                    if (a < 0) return -28
                    ...
                    function ct(e, r) {
                        try {
                            ...
                            return U.doStat(o.stat, t.path, r)
                        } catch (n) {
                            if (typeof o > 'u' || n.name !== 'ErrnoError')
                                throw n
                            return -n.errno
                        }
                    }
                    function dt(e, r, t) {
                        ...
                        try {
                            ...
                            switch (r) {
                                ...
                                case 21523: {
                                    ...
                                    if (n.tty.ops.ioctl_tiocgwinsz) {
                                        var B = n.tty.ops.ioctl_tiocgwinsz(
                                                n.tty,
                                            ),
                                            i = Oe()
                                        ;(W[i >> 1] = B[0]),
                            ...
                            if (typeof o > 'u' || y.name !== 'ErrnoError')
                                throw y
                            return -y.errno
                        }
                    }
                    function ft(e, r, t, n) {
                        try {
                            ...
                            return (
                                (n = n & -6401),
                                (r = U.calculateAt(e, r, i)),
                                U.doStat(a ? o.lstat : o.stat, r, t)
                            )
                        } catch (u) {
                    ...
                    function vt(e, r, t, n) {
                        U.varargs = n
                        try {
                            ;(r = U.getStr(r)), (r = U.calculateAt(e, r))
                            var a = n ? Se() : 0
                    ...
                    function _t(e) {
                        try {
                            return (e = U.getStr(e)), o.rmdir(e), 0
                        } catch (r) {
                    ...
                    function gt(e, r) {
                        try {
                            return (e = U.getStr(e)), U.doStat(o.stat, e, r)
                        } catch (t) {
                        ...
                        try {
                            return (
                                ...
                                t === 0
                                    ...
                                    : t === 512
                                      ? o.rmdir(r)
                                      : _e('Invalid flags passed to unlinkat'),
                                0
                            )
                        } catch (n) {
                            if (typeof o > 'u' || n.name !== 'ErrnoError')
                    ...
                    var wt = () => {
                        ...
                        yt = 1,
                        bt = () => yt,
                        Et = (e, r, t) => j.copyWithin(e, r, r + t),
                        ar = (e, r) =>
                            (r + 2097152) >>> 0 < 4194305 - !!e
                                ? (e >>> 0) + r * 4294967296
                                : NaN
                    function Mt(e, r, t, n, a, i, u, l) {
                        var v = ar(a, i)
                        try {
                            if (isNaN(v)) return 61
                            var E = U.getStreamFromFD(n),
                                G = o.mmap(E, e, v, r, t),
                                x = G.ptr
                            return (b[u >> 2] = G.allocated), (k[l >> 2] = x), 0
                        } catch (B) {
                            if (typeof o > 'u' || B.name !== 'ErrnoError')
                                throw B
                            return -B.errno
                        }
                    }
                    function Dt(e, r, t, n, a, i, u) {
                        var l = ar(i, u)
                        try {
                            var v = U.getStreamFromFD(a)
                            t & 2 && U.doMsync(e, v, r, n, l)
                        } catch (E) {
                            if (typeof o > 'u' || E.name !== 'ErrnoError')
                                throw E
                            return -E.errno
                        }
                    }
                    ...
                    var Ft = () => 2147483648,
                        ...
                        xt = e => {
                            ...
                            for (
                                ...
                                var u = Math.min(t, n(Math.max(e, i), 65536)),
                                    l = Ot(u)
                                if (l) return !0
                            }
                            return !1
                    ...
                    ;(o.createPreloadedFile = st), o.staticInit()
                    var Qt = {
                            a: Ar,
                            k: pt,
                            h: lt,
                        ...
                        N = Tr()
                    s._webidl_free = e => (s._webidl_free = N.D)(e)
                    s._free = e => (s._free = N.E)(e)
                    s._webidl_malloc = e => (s._webidl_malloc = N.F)(e)
                    s._malloc = e => (s._malloc = N.G)(e)
                    var yr = (s._emscripten_bind_VoidPtr___destroy___0 = e =>
                            (yr = s._emscripten_bind_VoidPtr___destroy___0 =
                                N.H)(e)),
                        br = (s._emscripten_bind_Graphviz_Graphviz_2 = (e, r) =>
                            (br = s._emscripten_bind_Graphviz_Graphviz_2 = N.I)(
                                e,
                                r,
                            )),
                        Er = (s._emscripten_bind_Graphviz_version_0 = () =>
                            (Er = s._emscripten_bind_Graphviz_version_0 =
                                N.J)()),
                        Mr = (s._emscripten_bind_Graphviz_lastError_0 = () =>
                            (Mr = s._emscripten_bind_Graphviz_lastError_0 =
                                N.K)()),
                        Dr = (s._emscripten_bind_Graphviz_createFile_2 = (
                            e,
                            r,
                            t,
                        ) =>
                            (Dr = s._emscripten_bind_Graphviz_createFile_2 =
                                N.L)(e, r, t)),
                        Xr = (s._emscripten_bind_Graphviz_layout_3 = (
                            e,
                            r,
                            t,
                            n,
                        ) =>
                            (Xr = s._emscripten_bind_Graphviz_layout_3 = N.M)(
                                e,
                                r,
                                t,
                                n,
                            )),
                        Lr = (s._emscripten_bind_Graphviz_acyclic_3 = (
                            e,
                            r,
                            t,
                            n,
                        ) =>
                            (Lr = s._emscripten_bind_Graphviz_acyclic_3 = N.N)(
                                e,
                                r,
                                t,
                                n,
                            )),
                        Br = (s._emscripten_bind_Graphviz_tred_3 = (
                            e,
                            r,
                            t,
                            n,
                        ) =>
                            (Br = s._emscripten_bind_Graphviz_tred_3 = N.O)(
                                e,
                                r,
                                t,
                                n,
                            )),
                        Rr = (s._emscripten_bind_Graphviz_unflatten_4 = (
                            e,
                            r,
                            t,
                            n,
                            ...
                            (Rr = s._emscripten_bind_Graphviz_unflatten_4 =
                                N.P)(e, r, t, n, a)),
                        kr = (s._emscripten_bind_Graphviz_get_layout_result_0 =
                            e =>
                                (kr =
                                    s._emscripten_bind_Graphviz_get_layout_result_0 =
                                        N.Q)(e)),
                        Gr = (s._emscripten_bind_Graphviz_set_layout_result_1 =
                            (e, r) =>
                                (Gr =
                                    s._emscripten_bind_Graphviz_set_layout_result_1 =
                                        N.R)(e, r)),
                        Fr =
                            (s._emscripten_bind_Graphviz_get_acyclic_outFile_0 =
                                e =>
                                    (Fr =
                                        s._emscripten_bind_Graphviz_get_acyclic_outFile_0 =
                                            N.S)(e)),
                        Or =
                            (s._emscripten_bind_Graphviz_set_acyclic_outFile_1 =
                                (e, r) =>
                                    (Or =
                                        s._emscripten_bind_Graphviz_set_acyclic_outFile_1 =
                                            N.T)(e, r)),
                                ...
                                e =>
                                    (xr =
                                        s._emscripten_bind_Graphviz_get_acyclic_num_rev_0 =
                                            N.U)(e)),
                        Ur =
                            (s._emscripten_bind_Graphviz_set_acyclic_num_rev_1 =
                                (e, r) =>
                                    (Ur =
                                        s._emscripten_bind_Graphviz_set_acyclic_num_rev_1 =
                                            N.V)(e, r)),
                        Nr = (s._emscripten_bind_Graphviz_get_tred_out_0 = e =>
                            (Nr = s._emscripten_bind_Graphviz_get_tred_out_0 =
                                N.W)(e)),
                        Vr = (s._emscripten_bind_Graphviz_set_tred_out_1 = (
                            e,
                            r,
                        ) =>
                            (Vr = s._emscripten_bind_Graphviz_set_tred_out_1 =
                                N.X)(e, r)),
                        Kr = (s._emscripten_bind_Graphviz_get_tred_err_0 = e =>
                            (Kr = s._emscripten_bind_Graphviz_get_tred_err_0 =
                                N.Y)(e)),
                        Cr = (s._emscripten_bind_Graphviz_set_tred_err_1 = (
                            e,
                            r,
                        ) =>
                            (Cr = s._emscripten_bind_Graphviz_set_tred_err_1 =
                                N.Z)(e, r)),
                        Ir = (s._emscripten_bind_Graphviz___destroy___0 = e =>
                            (Ir = s._emscripten_bind_Graphviz___destroy___0 =
                                N._)(e)),
                        Zr = (e, r) => (Zr = N.aa)(e, r),
                        Yr = e => (Yr = N.ba)(e)
                    s.UTF8ToString = ue
                    ...
                    zr()
                    function pe() {}
                    ;(pe.prototype = Object.create(pe.prototype)),
                        (pe.prototype.constructor = pe),
                        (pe.prototype.__class__ = pe),
                        (pe.__cache__ = {}),
                        (s.WrapperObject = pe)
                    function Te(e) {
                        return (e || pe).__cache__
                    }
                    s.getCache = Te
                    function ur(e, r) {
                        var t = Te(r),
                        ...
                        return (
                            n ||
                            ((n = Object.create((r || pe).prototype)),
                            (n.ptr = e),
                            (t[e] = n))
                        )
                    }
                    ...
                    ;(s.castObject = ro), (s.NULL = ur(0))
                    function to(e) {
                        if (!e.__destroy__)
                            throw 'Error: Cannot destroy object. (Did you create it yourself?)'
                        e.__destroy__(), delete Te(e.__class__)[e.ptr]
                    }
                    s.destroy = to
                    function oo(e, r) {
                        return e.ptr === r.ptr
                    ...
                    var F = {
                        ...
                        prepare() {
                            if (F.needed) {
                                for (var e = 0; e < F.temps.length; e++)
                                    s._webidl_free(F.temps[e])
                                ;(F.temps.length = 0),
                                    s._webidl_free(F.buffer),
                                    (F.buffer = 0),
                                    (F.size += F.needed),
                                    (F.needed = 0)
                            }
                            F.buffer ||
                                ((F.size += 128),
                                (F.buffer = s._webidl_malloc(F.size)),
                                J(F.buffer)),
                                (F.pos = 0)
                        },
                        alloc(e, r) {
                            ...
                            return (
                                F.pos + n >= F.size
                                    ? (J(n > 0),
                                      (F.needed += n),
                                      (a = s._webidl_malloc(n)),
                                      F.temps.push(a))
                                    : ((a = F.buffer + F.pos), (F.pos += n)),
                                a
                            )
                        },
                        copy(e, r, t) {
                    ...
                    ;(we.prototype = Object.create(pe.prototype)),
                        (we.prototype.constructor = we),
                        (we.prototype.__class__ = we),
                        (we.__cache__ = {}),
                        (s.VoidPtr = we),
                        (we.prototype.__destroy__ = we.prototype.__destroy__ =
                            function () {
                                var e = this.ptr
                                yr(e)
                            })
                    ...
                    return (
                        (g.prototype = Object.create(pe.prototype)),
                        (g.prototype.constructor = g),
                        (g.prototype.__class__ = g),
                        (g.__cache__ = {}),
                        (s.Graphviz = g),
                        (g.prototype.version = g.prototype.version =
                            function () {
                                return ue(Er())
                            }),
                        (g.prototype.lastError = g.prototype.lastError =
                            function () {
                                return ue(Mr())
                            }),
                        (g.prototype.createFile = g.prototype.createFile =
                            function (e, r) {
                                var t = this.ptr
                                F.prepare(),
                                    e && typeof e == 'object'
                        ...
                        (g.prototype.layout = g.prototype.layout =
                            function (e, r, t) {
                                var n = this.ptr
                                return (
                                    F.prepare(),
                        ...
                        (g.prototype.acyclic = g.prototype.acyclic =
                            function (e, r, t) {
                                var n = this.ptr
                                return (
                                    F.prepare(),
                        ...
                        (g.prototype.tred = g.prototype.tred =
                            function (e, r, t) {
                                var n = this.ptr
                                F.prepare(),
                                    e && typeof e == 'object'
                        ...
                        (g.prototype.unflatten = g.prototype.unflatten =
                            function (e, r, t, n) {
                                var a = this.ptr
                                return (
                                    F.prepare(),
                        ...
                        (g.prototype.get_layout_result =
                            g.prototype.get_layout_result =
                                function () {
                                    var e = this.ptr
                                    return ue(kr(e))
                                }),
                        (g.prototype.set_layout_result =
                            g.prototype.set_layout_result =
                                function (e) {
                                    var r = this.ptr
                                    F.prepare(),
                        ...
                        Object.defineProperty(g.prototype, 'layout_result', {
                            get: g.prototype.get_layout_result,
                            set: g.prototype.set_layout_result,
                        }),
                        (g.prototype.get_acyclic_outFile =
                            g.prototype.get_acyclic_outFile =
                                function () {
                                    var e = this.ptr
                                    return ue(Fr(e))
                                }),
                        (g.prototype.set_acyclic_outFile =
                            g.prototype.set_acyclic_outFile =
                                function (e) {
                                    var r = this.ptr
                                    F.prepare(),
                        ...
                        Object.defineProperty(g.prototype, 'acyclic_outFile', {
                            get: g.prototype.get_acyclic_outFile,
                            set: g.prototype.set_acyclic_outFile,
                        }),
                        ...
                        (g.prototype.set_acyclic_num_rev =
                            g.prototype.set_acyclic_num_rev =
                                function (e) {
                                    var r = this.ptr
                                    e && typeof e == 'object' && (e = e.ptr),
                        ...
                        Object.defineProperty(g.prototype, 'acyclic_num_rev', {
                            get: g.prototype.get_acyclic_num_rev,
                            set: g.prototype.set_acyclic_num_rev,
                        }),
                        (g.prototype.get_tred_out = g.prototype.get_tred_out =
                            function () {
                                var e = this.ptr
                                return ue(Nr(e))
                            }),
                        (g.prototype.set_tred_out = g.prototype.set_tred_out =
                            function (e) {
                                var r = this.ptr
                                F.prepare(),
                                    e && typeof e == 'object'
                        ...
                        Object.defineProperty(g.prototype, 'tred_out', {
                            get: g.prototype.get_tred_out,
                            set: g.prototype.set_tred_out,
                        }),
                        (g.prototype.get_tred_err = g.prototype.get_tred_err =
                            function () {
                                var e = this.ptr
                                return ue(Kr(e))
                            }),
                        (g.prototype.set_tred_err = g.prototype.set_tred_err =
                            function (e) {
                                var r = this.ptr
                                F.prepare(),
                                    e && typeof e == 'object'
                        ...
                        Object.defineProperty(g.prototype, 'tred_err', {
                            get: g.prototype.get_tred_err,
                            set: g.prototype.set_tred_err,
                        }),
                ...
                if (h !== -1)
                    if (m < 0) m = h
                        ...
                        ;(m += h * 91),
                            (s |= m << f),
                            (f += (m & 8191) > 88 ? 13 : 14)
                        do d.push(s & 255), (s >>= 8), (f -= 8)
                        while (f > 7)
                        m = -1
                    }
            }
            return m > -1 && d.push((s | (m << f)) & 255), new Uint8Array(d)
        }
        var Bo =
        ...
        function Ro() {
            return (
                lr || (lr = Eo(Lo(Bo))),
                ze || (ze = Do({ wasmBinary: lr, locateFile: void 0 })),
                ze
            )
        }
        function ko() {
...
<svg width="${p.width}" height="${p.height}"></svg>`,
            }
        }
        function Fo(p) {
            return p.map(Go)
        ...
        function Oo(p, c) {
            let d = { images: [], files: [], ...c }
            ;[...d.files, ...Fo(d.images)].forEach(s =>
                p.createFile(s.path, s.data),
            )
        }
        var xo = class Ue {
            constructor(c) {
            ...
            layout(c, d = 'svg', s = 'dot', f) {
                if (!c) return ''
                let m = new this._module.Graphviz(
                        f?.yInvert ? 1 : 0,
                        f?.nop ? f?.nop : 0,
                    ),
                    _ = '',
                ...
                if (!_ && h) throw (Ue.unload(), new Error(h))
                return _
            }
            acyclic(c, d = !1, s = !1) {
                if (!c) return { acyclic: !1, num_rev: 0, outFile: '' }
                let f = new this._module.Graphviz(),
                    m = !1,
                    _ = 0,
                    h = '',
                    M = ''
                try {
                    ...
                    this._module.destroy(f)
                }
                if (M) throw (Ue.unload(), new Error(M))
                return { acyclic: m, num_rev: _, outFile: h }
            }
            tred(c, d = !1, s = !1) {
                if (!c) return { out: '', err: '' }
                let f = new this._module.Graphviz(),
                ...
                try {
                    try {
                        f.tred(c, d, s), (m = f.tred_out), (_ = f.tred_err)
                    } catch (M) {
                        h = M.message
                    }
                    h = f.lastError() || h
                ...
                if (!m && h) throw (Ue.unload(), new Error(h))
                return { out: m, err: _ }
            }
            unflatten(c, d = 0, s = !1, f = 0) {
                if (!c) return ''
                let m = new this._module.Graphviz(),
                    _ = '',
                    h = ''
            ...
            circo(c, d = 'svg', s) {
                return this.layout(c, d, 'circo', s)
            }
            dot(c, d = 'svg', s) {
                return this.layout(c, d, 'dot', s)
            }
            fdp(c, d = 'svg', s) {
                return this.layout(c, d, 'fdp', s)
            }
            sfdp(c, d = 'svg', s) {
                return this.layout(c, d, 'sfdp', s)
            }
            neato(c, d = 'svg', s) {
                return this.layout(c, d, 'neato', s)
            }
            osage(c, d = 'svg', s) {
                return this.layout(c, d, 'osage', s)
            }
            patchwork(c, d = 'svg', s) {
                return this.layout(c, d, 'patchwork', s)
            }
            twopi(c, d = 'svg', s) {
                return this.layout(c, d, 'twopi', s)
            }
            nop(c) {
        ...
        function convertToPathData(originalData, guideData) {
            if (originalData.tag == 'polygon') {
                ...
                if (guideData.tag == 'polygon') {
                    ...
                    var newPointStrings = [
                        [bbox.cx + x2, bbox.cy + 0].join(','),
                    ]
                    newPointStrings = newPointStrings.concat(
                        pointStrings.slice(i),
                    )
                    newPointStrings = newPointStrings.concat(
                        pointStrings.slice(0, i),
                    )
            ...
            if (this._worker != null) {
                ...
                postMessage.call(
                    ...
                    function (event) {
                        switch (event.data.type) {
                            case 'version':
                                graphvizInstance._graphvizVersion =
                                    event.data.version
        ...
        function layoutDone(svgDoc, callback) {
            ...
            if (
                ...
                var tweenPrecision =
                    +this._options.tweenPrecision.split('%')[0] / 100
                ...
                if (tweenShapes && datum.id in prevDictionary) {
                    if (
                        ...
                        if (prevDatum.tag != 'path') {
                            datum.alternativeOld = convertToPathData(
                                prevDatum,
                                datum,
                            )
                        }
                        if (datum.tag != 'path') {
                            datum.alternativeNew = convertToPathData(
                                datum,
                                prevDatum,
                            )
                        }
            ...
            function calculatePathTweenPoints(datum, prevDatum) {
                if (
                    ...
                    prevDatum &&
                    (prevDatum.tag == 'path' ||
                        (datum.alternativeOld &&
                            datum.alternativeOld.tag == 'path'))
                ) {
                    var attribute_d = (datum.alternativeNew || datum).attributes
                        .d
                    if (datum.alternativeOld) {
                        var oldNode = createElementWithAttributes(
                            datum.alternativeOld,
                        )
                    } else {
                    ...
                    ;(
                        datum.alternativeOld || (datum.alternativeOld = {})
                    ).points = pathTweenPoints(
                        oldNode,
                        attribute_d,
                        tweenPrecision,
                ...
                if (growEnteringEdges && !prevDatum && datum.parent) {
                    if (isEdgeElement(datum)) {
                        if (tag == 'path' || tag == 'polygon') {
                            if (tag == 'polygon') {
                                var path = datum.parent.children.find(
                                    function (e) {
                                        return e.tag == 'path'
                                    },
                                )
                            ...
                            if (
                                Object.hasOwn(prevNodeDictionary, startNodeId)
                            ) {
                                var prevStartNode =
                                    prevNodeDictionary[startNodeId]
                                var i = startNode.children.findIndex(
                                    function (element, index) {
                                        return element.tag == 'g'
                                    },
                                )
                                if (i >= 0) {
                                    var j = startNode.children[
                                        i
                                    ].children.findIndex(
                                        function (element, index) {
                                    ...
                                    startNode =
                                        startNode.children[i].children[j]
                                }
                                ...
                                if (i >= 0) {
                                    ...
                                    prevStartNode =
                                        prevStartNode.children[i].children[j]
                                }
                                ...
                                if (prevStartShape && startShape) {
                                    datum.offset = {
                                        x:
                                            prevStartShape.center.x -
                                            startShape.center.x,
                                        y:
                                            prevStartShape.center.y -
                                            startShape.center.y,
                                    }
                                } else {
                                    datum.offset = {
                        ...
                        enable
                            ? function () {
                                  ...
                                  string +=
                                      eventType +
                                      ' '.repeat(
                                          maxEventTypeLength - eventType.length,
                                      )
                                  string += d3Format.format(' >5')(t - t0) + ' '
                                  if (eventType != 'initEnd') {
                                      string += d3Format.format(' >5')(
                                          t - times['start'][seqNo],
                                      )
                                  }
                                  ...
                                  if (
                                      ...
                                      expectedDelay =
                                          graphvizInstance._transition.delay()
                                      expectedDuration =
                                          graphvizInstance._transition.duration()
                                  }
                                  if (eventType == 'transitionStart') {
                                      ...
                                      string +=
                                          ' expected ' +
                                          d3Format.format(' >5')(expectedDelay)
                                      string +=
                                          ' diff ' +
                                          d3Format.format(' >5')(
        ...
        function _moveNode(node, x, y, attributes, options) {
            ...
            var svgElements = subParent.selectAll(
            ...
            if (text.size() != 0) {
                text.attr(
                    'x',
                    roundTo2Decimals(+text.attr('x') + x - bbox.cx),
        ...
        function insertDrawnNode(nodeId) {
            ...
            if (attributes.URL || attributes.tooltip) {
                ...
                node.selectWithoutDataPropagation(
                    'ellipse,polygon,path,polyline',
                )
                var text = node.selectWithoutDataPropagation('text')
            }
        ...
        function Graphviz(selection, options) {
            ...
            if (useWorker || useSharedWorker) {
                ...
                var vizScript = scripts.filter(function () {
                    return (
                        d3__namespace.select(this).attr('type') ==
                            'javascript/worker' ||
